            ...
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb d-flex align-items-center">
                  ...
                  />
                  <li class="breadcrumb-item">
                    <router-link :to="{ name: 'screensaver' }" class="breadcrumb-link"
                  ...
                  <li class="breadcrumb-item" aria-current="page">
                    <router-link :about="{ name: 'screensaver' }" class="breadcrumb-link">{{
                      media.title
                    }}</router-link>
                  </li>
                  <font-awesome-icon
                ...
                <div class="row">
                  <div class="form-group col">
                    ...
                    <small id="customerHelp" class="form-text text-muted">
                      Ce média sera seulement accessibles par les clients sélectionnés et diffusés seulement sur les Arcades For Good de ces clients.
                    </small>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    fetchMedia() {
      ...
      this.$http
        .get("screensaver-media/" + this.$route.params.id + "/")
        .then((resp) => {
